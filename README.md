...
- Per‑target language TM index pattern: `<source_lang>-<target_lang>`
...
When a target language is first used we create an index: `<source_lang>-<target_lang>` with mapping:
